...
namespace Composite
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // компоненты-листья...
            Product leaf = new Product("Pen");
            Console.WriteLine("Client: I get a simple component:");
            client.ClientCode(leaf);

            // ...а также сложные контейнеры.
            Case tree = new Case();
            Case branch1 = new Case();
            branch1.Add(new Product("Sugar"));
            branch1.Add(new Product("Pepper"));
            Case branch2 = new Case();
            branch2.Add(new Product("Chair"));
            tree.Add(branch1);
            tree.Add(branch2);
